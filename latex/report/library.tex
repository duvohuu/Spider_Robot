...
\lstdefinestyle{Rstyle}{
    ...
    showstringspaces=false,
    captionpos=b,
    morekeywords={data.frame,library,require,function,return,if,else,for,while,repeat,in,next,break,TRUE,FALSE,NULL,NA,NaN,Inf},
    emph={anova,shapiro.test,aov,t.test,wilcox.test,chisq.test,lm,glm,summary},
    emphstyle=\color{magenta!80!black}\bfseries,
    literate=
        {<-}{{{\color{red!70!black}\textbf{<-}}}}2
        {\%>\%}{{{\color{teal!70!black}\textbf{\%>\%}}}}3
}
...
\numberwithin{equation}{chapter}  % Công thức: (1.1), (1.2), (2.1)...
